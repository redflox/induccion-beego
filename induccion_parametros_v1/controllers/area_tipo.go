...
import (
	...
	"github.com/induccion-beego/induccion_parametros_v1/models"
...
func (c *AreaTipoController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"Success": true, "Message": "Request successful", "Data": l}
	}
	c.ServeJSON()
}
...
func (c *AreaTipoController) Delete() {
	...
	if err := models.DeleteAreaTipo(id); err == nil {
		...
		c.Data["json"] = map[string]interface{}{"Success": true, "Status": true, "Message": "Delete successful", "Data": d}
	} else {
		logs.Error(err)
